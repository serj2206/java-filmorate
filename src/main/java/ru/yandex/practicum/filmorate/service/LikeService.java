...
public class LikeService {
    ...
    public boolean add(Long filmId, Long userId) {
        log.debug(" LikeService.addLike(filmId = {}, userId = {})", filmId, userId);
    ...
    public boolean delete(Long filmId, Long userId) {
        log.debug(" LikeService.deleteLike(filmId = {}, userId = {})", filmId, userId);
        findUserById(userId);
        filmDbStorage.findFilmById(filmId);
    ...
    public User findUserById(Long id) {
        log.debug(" LikeService.findUserById(id = {})", id);
    ...
    public Film findFilmById(Long id) {
        log.debug(" LikeService.findFilmById(id = {})", id);
